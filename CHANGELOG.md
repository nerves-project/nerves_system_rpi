...
* Improvements
  * Include software versioning and licensing info (see legal-info directory in
    artifact)
  * Support use of Bluetooth when running on the Raspberry Pi Zero W.
...
* Bug fixes
  * Support the Raspberry Pi Zero (no W) by including its device tree files
  * Add WiFi Firmware configuration for RPi0W to fix kernel warning
